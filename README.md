...
This project implements **Crowdfund Hub** functionality on Arc Network's testnet. Arc uses USDC as native gas token (6 decimals), providing a stable and predictable fee structure for DeFi applications.
